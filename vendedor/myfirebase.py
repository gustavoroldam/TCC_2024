...
class MyFirebase():
    ...
    def criar_conta(self, nome, senha):
        ...
        requisicao = requests.post(f"https://tcc2023-9212b-default-rtdb.firebaseio.com/Funcionarios/Vendedor.json", data=json.dumps(dados))
    ...
    def fazer_login(self, nome, senha):
        requisicao = requests.get(f"https://tcc2023-9212b-default-rtdb.firebaseio.com/Funcionarios/Vendedor.json")
