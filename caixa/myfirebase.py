...
class MyFirebase():
    ...
    def criar_conta(self, nome, senha):
        ...
        requisicao = requests.post(f"https://tcc2023-9212b-default-rtdb.firebaseio.com/Funcionarios/Caixa.json", data=json.dumps(dados))
    ...
    def fazer_login(self, nome, senha):
        meu_aplicativo = App.get_running_app()
        dic_requisicao = meu_aplicativo.Requisicao_Get(f"https://tcc2023-9212b-default-rtdb.firebaseio.com/Funcionarios/Caixa")
        id = -1
